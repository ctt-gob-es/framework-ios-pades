...
import harmony.java.awt.AWTRectangle;
...
public class Polygon implements Shape, Serializable {
	...
	public AWTRectangle getBounds() {
		...
		return bounds = new AWTRectangle(bx1, by1, bx2 - bx1, by2 - by1);
	}
	 ...
	 */
	@Deprecated
	public AWTRectangle getBoundingBox() {
		return getBounds();
	}
