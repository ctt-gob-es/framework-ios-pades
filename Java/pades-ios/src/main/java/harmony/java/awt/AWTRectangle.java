...
public class AWTRectangle extends Rectangle2D implements Shape, Serializable {
	...
	public AWTRectangle(Point p) {
		setBounds(p.x, p.y, 0, 0);
	}

	public AWTRectangle(Point p, Dimension d) {
	...
	public AWTRectangle(int width, int height) {
		setBounds(0, 0, width, height);
	}

	public AWTRectangle(AWTRectangle r) {
		setBounds(r.x, r.y, r.width, r.height);
	}

	public AWTRectangle(Dimension d) {
	...
	public void setBounds(AWTRectangle r) {
		setBounds(r.x, r.y, r.width, r.height);
	}
	...
	public void add(AWTRectangle r) {
	...
	public boolean contains(AWTRectangle r) {
	...
	public Rectangle2D createIntersection(Rectangle2D r) {
		if (r instanceof AWTRectangle) {
			return intersection((AWTRectangle) r);
		}
	...
	public AWTRectangle intersection(AWTRectangle r) {
		int x1 = Math.max(x, r.x);
		int y1 = Math.max(y, r.y);
		int x2 = Math.min(x + width, r.x + r.width);
		int y2 = Math.min(y + height, r.y + r.height);
		return new AWTRectangle(x1, y1, x2 - x1, y2 - y1);
	}

	public boolean intersects(AWTRectangle r) {
	...
	public AWTRectangle union(AWTRectangle r) {
		AWTRectangle dst = new AWTRectangle(this);
		dst.add(r);
		return dst;
	}
	...
	public boolean equals(Object obj) {
		...
		if (obj instanceof AWTRectangle) {
			AWTRectangle r = (AWTRectangle) obj;
