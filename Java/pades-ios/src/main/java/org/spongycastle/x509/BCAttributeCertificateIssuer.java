 ...
 */
public class BCAttributeCertificateIssuer
    implements CertSelector, Selector
{
     ...
     */
    public BCAttributeCertificateIssuer(AttCertIssuer issuer)
    {
        form = issuer.getIssuer();
    }

    public BCAttributeCertificateIssuer(X500Principal principal)
        throws IOException
    {
        this(new X509Principal(principal.getEncoded()));
    }

    public BCAttributeCertificateIssuer(X509Principal principal)
    {
    ...
    public Object clone()
    {
        return new BCAttributeCertificateIssuer(AttCertIssuer.getInstance(form));
    }
    ...
    public boolean equals(Object obj)
    {
        ...
        if (!(obj instanceof BCAttributeCertificateIssuer))
        {
            return false;
        }

        BCAttributeCertificateIssuer other = (BCAttributeCertificateIssuer)obj;
