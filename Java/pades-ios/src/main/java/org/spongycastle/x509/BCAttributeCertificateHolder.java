 ...
 */
public class BCAttributeCertificateHolder
    implements CertSelector, Selector
{
    final Holder holder;

    BCAttributeCertificateHolder(ASN1Sequence seq)
    {
        holder = Holder.getInstance(seq);
    }

    public BCAttributeCertificateHolder(X509Principal issuerName,
    ...
    public BCAttributeCertificateHolder(X500Principal issuerName,
        BigInteger serialNumber)
    {
        this(X509Util.convertPrincipal(issuerName), serialNumber);
    }

    public BCAttributeCertificateHolder(X509Certificate cert)
    ...
    public BCAttributeCertificateHolder(X509Principal principal)
    {
        holder = new Holder(generateGeneralNames(principal));
    }

    public BCAttributeCertificateHolder(X500Principal principal)
    {
     ...
     */
    public BCAttributeCertificateHolder(int digestedObjectType,
    ...
    public Object clone()
    {
        return new BCAttributeCertificateHolder((ASN1Sequence)holder
            .toASN1Primitive());
    }
    ...
    public boolean equals(Object obj)
    {
        ...
        if (!(obj instanceof BCAttributeCertificateHolder))
        {
            return false;
        }

        BCAttributeCertificateHolder other = (BCAttributeCertificateHolder)obj;
