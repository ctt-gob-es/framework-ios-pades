...
import org.spongycastle.asn1.x509.BCKeyUsage;
 ...
 */
public class BCX509CertificateObject
    ...
    implements PKCS12BagAttributeCarrier
{
    ...
    public BCX509CertificateObject(
            ...
            while (e.hasMoreElements())
            {
                ...
                if (ext.getExtnValue() != null)
                {
                    ...
                    try
                    {
                        ...
                        {
                            buf.append(BCKeyUsage.getInstance(dIn.readObject())).append(nl);
                        }
    ...
    {
        Signature   signature;
        String      sigName = BCX509SignatureUtil.getSignatureName(c.getSignatureAlgorithm());
            ...
            SignatureException, InvalidKeyException
    {
        ...
        BCX509SignatureUtil.setSignatureParameters(signature, params);
