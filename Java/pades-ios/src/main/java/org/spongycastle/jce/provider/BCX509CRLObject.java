 ...
 * @deprecated Do not use this class directly - either use org.spongycastle.cert (bcpkix) or CertificateFactory.
 */
public class BCX509CRLObject
    extends X509CRL
{
        ...
        throws CRLException
    {
        ...
        {
            throw new BCExtCRLException(
                    "Exception reading IssuingDistributionPoint", e);
        }
    }

    public BCX509CRLObject(
        CertificateList c)
        throws CRLException
    {
        this.c = c;
        ...
        try
        {
            this.sigAlgName = BCX509SignatureUtil.getSignatureName(c.getSignatureAlgorithm());
    ...
    private Set loadCRLEntries()
    {
        ...
        while (certs.hasMoreElements())
        {
            ...
            BCX509CRLEntryObject crlEntry = new BCX509CRLEntryObject(entry, isIndirect, previousCertificateIssuer);
    ...
    public X509CRLEntry getRevokedCertificate(BigInteger serialNumber)
    {
        ...
        while (certs.hasMoreElements())
        {
            ...
            {
                return new BCX509CRLEntryObject(entry, isIndirect, previousCertificateIssuer);
            }
    ...
    public boolean equals(Object other)
    {
        ...
        if (other instanceof BCX509CRLObject)
        {
            BCX509CRLObject crlObject = (BCX509CRLObject)other;
