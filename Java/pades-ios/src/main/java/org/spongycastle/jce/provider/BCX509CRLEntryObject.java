 ...
 * (critical)
 */
public class BCX509CRLEntryObject extends X509CRLEntry
{
    ...
    public BCX509CRLEntryObject(TBSCertList.CRLEntry c)
    {
        this.c = c;
    ...
    public boolean equals(Object o)
    {
        ...
        if (o instanceof BCX509CRLEntryObject)
        {
            BCX509CRLEntryObject other = (BCX509CRLEntryObject)o;
