...
import org.spongycastle.asn1.pkcs.BCSignedData;
...
{
    private static final BCPEMUtil PEM_PARSER = new BCPEMUtil("CRL");
        ...
        throws IOException, CRLException
    {
                ...
                && seq.getObjectAt(0) instanceof ASN1ObjectIdentifier)
        {
            ...
            {
                sData = new BCSignedData(ASN1Sequence.getInstance(
        ...
        return new BCX509CRLObject(CertificateList.getInstance(seq));
    }
