    ...
    implements KeyTransRecipient
{
    ...
    {
        this.contentHelper = BCCMSUtils.createContentHelper(provider);
    ...
    {
        this.contentHelper = BCCMSUtils.createContentHelper(providerName);
    ...
    protected Key extractSecretKey(AlgorithmIdentifier keyEncryptionAlgorithm, AlgorithmIdentifier encryptedKeyAlgorithm, byte[] encryptedEncryptionKey)
        throws CMSException
    {
        if (BCCMSUtils.isGOST(keyEncryptionAlgorithm.getAlgorithm()))
        {
            try
            {
