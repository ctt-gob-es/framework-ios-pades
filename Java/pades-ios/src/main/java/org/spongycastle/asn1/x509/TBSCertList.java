    ...
    extends ASN1Object
{
        ...
        extends ASN1Object
    {
        ...
        public BCTime getRevocationDate()
        {
            return BCTime.getInstance(seq.getObjectAt(1));
        }
        ...
        ASN1Sequence  seq)
    {
        ...
        thisUpdate = BCTime.getInstance(seq.getObjectAt(seqPos++));

        if (seqPos < seq.size()
            && (seq.getObjectAt(seqPos) instanceof ASN1UTCTime
               || seq.getObjectAt(seqPos) instanceof ASN1GeneralizedTime
               || seq.getObjectAt(seqPos) instanceof BCTime))
        {
            nextUpdate = BCTime.getInstance(seq.getObjectAt(seqPos++));
        }
    ...
    public BCTime getThisUpdate()
    {
        return thisUpdate;
    }

    public BCTime getNextUpdate()
    {
        return nextUpdate;
    }
