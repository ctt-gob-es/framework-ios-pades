    ...
    implements X509ObjectIdentifiers, PKCSObjectIdentifiers
{
        ...
        ASN1Sequence  seq)
    {
        ...
        startDate = BCTime.getInstance(dates.getObjectAt(0));
        endDate = BCTime.getInstance(dates.getObjectAt(1));
    ...
    public BCTime getStartDate()
    {
        return startDate;
    }

    public BCTime getEndDate()
    {
        return endDate;
    }
