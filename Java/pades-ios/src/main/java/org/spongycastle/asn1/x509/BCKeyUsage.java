    ...
    extends ASN1Object
{
    ...
    public static BCKeyUsage getInstance(Object obj)   // needs to be DERBitString for other VMs
    {
        if (obj instanceof BCKeyUsage)
        {
            return (BCKeyUsage)obj;
        }
        else if (obj != null)
        {
            return new BCKeyUsage(DERBitString.getInstance(obj));
        }

        return null;
    }

    public static BCKeyUsage fromExtensions(Extensions extensions)
    {
        return BCKeyUsage.getInstance(extensions.getExtensionParsedValue(Extension.keyUsage));
    }
