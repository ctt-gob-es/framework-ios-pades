...
import com.aowagie.text.pdf.fonts.FontsResourceAnchor;
    ...
    Type1Font(final String afmFile, final String enc, final boolean emb, final byte ttfAfm[], final byte pfb[], final boolean forceRead)
        ...
        if (BuiltinFonts14.containsKey(afmFile)) {
            ...
            try {
                ...
                if (is == null) {
                    final String msg = afmFile + " not found as resource. (The *.afm files must exist as resources in the package com.aowagie.text.pdf.fonts)";
