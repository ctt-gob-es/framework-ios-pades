...
import com.aowagie.text.pdf.PdfPTableEvent;
...
public class SimpleTable extends Rectangle implements PdfPTableEvent, TextElementArray {
	...
	/**
     * @see com.aowagie.text.pdf.PdfPTableEvent#tableLayout(com.aowagie.text.pdf.PdfPTable, float[][], float[], int, int, com.aowagie.text.pdf.PdfContentByte[])
 	 */
	@Override
	...
	/**
	 * @see com.aowagie.text.TextElementArray#add(java.lang.Object)
	 */
	@Override
