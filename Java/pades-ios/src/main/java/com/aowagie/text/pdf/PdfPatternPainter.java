...
public final class PdfPatternPainter extends PdfTemplate {
    ...
    /**
     * @see com.aowagie.text.pdf.PdfContentByte#setGrayFill(float)
     */
    @Override
    ...
    /**
     * @see com.aowagie.text.pdf.PdfContentByte#resetGrayFill()
     */
    @Override
    ...
    /**
     * @see com.aowagie.text.pdf.PdfContentByte#setGrayStroke(float)
     */
    @Override
    ...
    /**
     * @see com.aowagie.text.pdf.PdfContentByte#resetGrayStroke()
     */
    @Override
    ...
    /**
     * @see com.aowagie.text.pdf.PdfContentByte#setRGBColorFillF(float, float, float)
     */
    @Override
    ...
    /**
     * @see com.aowagie.text.pdf.PdfContentByte#resetRGBColorFill()
     */
    @Override
    ...
    /**
     * @see com.aowagie.text.pdf.PdfContentByte#setRGBColorStrokeF(float, float, float)
     */
    @Override
    ...
    /**
     * @see com.aowagie.text.pdf.PdfContentByte#resetRGBColorStroke()
     */
    @Override
    ...
    /**
     * @see com.aowagie.text.pdf.PdfContentByte#setCMYKColorFillF(float, float, float, float)
     */
    @Override
    ...
    /**
     * @see com.aowagie.text.pdf.PdfContentByte#resetCMYKColorFill()
     */
    @Override
    ...
    /**
     * @see com.aowagie.text.pdf.PdfContentByte#setCMYKColorStrokeF(float, float, float, float)
     */
    @Override
    ...
    /**
     * @see com.aowagie.text.pdf.PdfContentByte#resetCMYKColorStroke()
     */
    @Override
    ...
    /**
     * @see com.aowagie.text.pdf.PdfContentByte#addImage(com.aowagie.text.Image, float, float, float, float, float, float)
     */
    @Override
    ...
    /**
     * @see com.aowagie.text.pdf.PdfContentByte#setCMYKColorFill(int, int, int, int)
     */
    @Override
    ...
    /**
     * @see com.aowagie.text.pdf.PdfContentByte#setCMYKColorStroke(int, int, int, int)
     */
    @Override
    ...
    /**
     * @see com.aowagie.text.pdf.PdfContentByte#setRGBColorFill(int, int, int)
     */
    @Override
    ...
    /**
     * @see com.aowagie.text.pdf.PdfContentByte#setRGBColorStroke(int, int, int)
     */
    @Override
    ...
    /**
     * @see com.aowagie.text.pdf.PdfContentByte#setColorFill(com.aowagie.text.pdf.PdfSpotColor, float)
     */
    @Override
    ...
    /**
     * @see com.aowagie.text.pdf.PdfContentByte#setColorStroke(com.aowagie.text.pdf.PdfSpotColor, float)
     */
    @Override
    ...
    /**
     * @see com.aowagie.text.pdf.PdfContentByte#setPatternFill(com.aowagie.text.pdf.PdfPatternPainter)
     */
    @Override
    ...
    /**
     * @see com.aowagie.text.pdf.PdfContentByte#setPatternStroke(com.aowagie.text.pdf.PdfPatternPainter)
     */
    @Override
