...
public class ITextBase64 {
     ...
     * @return bytes
     * @see ITextBase64#GZIP
     * @see ITextBase64#DONT_BREAK_LINES
     * @since 2.0
     */
    private static String encodeBytes( final byte[] source, final int off, final int len, final int options ) {
        ...
        if( gzip == GZIP ) {
            ...
            ITextBase64.OutputStream            b64os = null;


            try {
                // GZip -> Base64 -> ByteArray
                baos = new java.io.ByteArrayOutputStream();
                b64os = new ITextBase64.OutputStream( baos, ENCODE | options );
    ...
    private static byte[] decodeFromFile( final String filename ) {
        ...
        ITextBase64.InputStream bis = null;
        try {
            ...
            // Open a stream
            bis = new ITextBase64.InputStream(
                    new java.io.BufferedInputStream(
                    new java.io.FileInputStream( file ) ), ITextBase64.DECODE );
    ...
    private static String encodeFromFile( final String filename ) {
        ...
        try {
            ...
            bis = new ITextBase64.InputStream(
                    new java.io.BufferedInputStream(
                    new java.io.FileInputStream( file ) ), ITextBase64.ENCODE );
            ...
            // Save in a variable to return
            encodedData = new String( buffer, 0, length, ITextBase64.PREFERRED_ENCODING );
    ...
    private static void encodeFileToFile( final String infile, final String outfile ) {
        final String encoded = ITextBase64.encodeFromFile( infile );
    ...
    private static void decodeFileToFile( final String infile, final String outfile ) {
        final byte[] decoded = ITextBase64.decodeFromFile( infile );
        java.io.OutputStream out = null;
        try{
            out = new java.io.BufferedOutputStream(
                    new java.io.FileOutputStream( outfile ) );
    ...
    /**
     * A {@link ITextBase64.InputStream} will read data from another
    ...
    private static class InputStream extends java.io.FilterInputStream {
        ...
        /**
         * Constructs a {@link ITextBase64.InputStream} in
         ...
         * @param options Specified options
         * @see ITextBase64#ENCODE
         * @see ITextBase64#DECODE
         * @see ITextBase64#DONT_BREAK_LINES
         * @since 2.0
         */
    ...
    /**
     * A {@link ITextBase64.OutputStream} will write data to another
    ...
    private static class OutputStream extends java.io.FilterOutputStream {
        ...
        /**
         * Constructs a {@link ITextBase64.OutputStream} in
         * either ENCODE or DECODE mode.
         * <p>
         * Valid options:<pre>
         *   ENCODE or DECODE: Encode or Decode as data is read.
		...
		public void write(final int theByte) throws java.io.IOException {
            ...
            // Else, Decoding
                ...
                if( this.decodabet[ theByte & 0x7f ] > WHITE_SPACE_ENC ) {
                    ...
                    {
                        final int len = ITextBase64.decode4to3( this.buffer, 0, this.b4, 0, this.options );
