...
#pragma push_macro("INCLUDE_ALL_EsGobAfirmaSignersPadesPdfUtil")
#ifdef RESTRICT_EsGobAfirmaSignersPadesPdfUtil
#define INCLUDE_ALL_EsGobAfirmaSignersPadesPdfUtil 0
#else
#define INCLUDE_ALL_EsGobAfirmaSignersPadesPdfUtil 1
#endif
#undef RESTRICT_EsGobAfirmaSignersPadesPdfUtil

#if !defined (EsGobAfirmaSignersPadesPdfUtil_) && (INCLUDE_ALL_EsGobAfirmaSignersPadesPdfUtil || defined(INCLUDE_EsGobAfirmaSignersPadesPdfUtil))
...
#if !defined (EsGobAfirmaSignersPadesPdfUtil_SignatureField_) && (INCLUDE_ALL_EsGobAfirmaSignersPadesPdfUtil || defined(INCLUDE_EsGobAfirmaSignersPadesPdfUtil_SignatureField))
...
#pragma pop_macro("INCLUDE_ALL_EsGobAfirmaSignersPadesPdfUtil")
