...
#pragma push_macro("INCLUDE_ALL_ComAowagieTextPdfPdfEncryption")
#ifdef RESTRICT_ComAowagieTextPdfPdfEncryption
#define INCLUDE_ALL_ComAowagieTextPdfPdfEncryption 0
#else
#define INCLUDE_ALL_ComAowagieTextPdfPdfEncryption 1
#endif
#undef RESTRICT_ComAowagieTextPdfPdfEncryption

#if !defined (ComAowagieTextPdfPdfEncryption_) && (INCLUDE_ALL_ComAowagieTextPdfPdfEncryption || defined(INCLUDE_ComAowagieTextPdfPdfEncryption))
...
#pragma pop_macro("INCLUDE_ALL_ComAowagieTextPdfPdfEncryption")
